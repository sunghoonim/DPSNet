...
path1 = '/data1/mvstereo/mvs_source/'

def dump_example(dataset_name):
    print("Converting {:}.h5 ...".format(dataset_name))
    file = h5py.File(os.path.join(path1, "{:}.h5".format(dataset_name)), "r")
    ...
    for (seq_idx, seq_name) in enumerate(file):
        if dataset_name == 'scenes11_train':
            ...
            scale = 1
        if not ((dataset_name == 'sun3d_train_1.6m_to_infm' and seq_idx == 7) or (dataset_name == 'sun3d_train_0.4m_to_0.8m' and seq_idx == 15) or (dataset_name == 'scenes11_train' and (seq_idx == 2758 or seq_idx == 4691 or seq_idx == 7023 or seq_idx == 11157 or seq_idx == 17168 or seq_idx == 19595))):
